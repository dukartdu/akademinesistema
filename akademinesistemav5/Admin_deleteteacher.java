...
public class Admin_deleteteacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pasalinti destytoja");

        jLabel2.setText("Iveskite vartotojo ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ptst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Irasas istrintas sekmingai!");
            conn.close();
         }catch (Exception e){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_deleteteacher().setVisible(true);
            }
        });
    }
